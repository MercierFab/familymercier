    ...
    <body>
        ...
        <section>
            ...
            <article>
                ...
                {
                    echo 
                    '<tr><td>' . $donnees['year(`date`)'] . '</td><td>' . $donnees['min(TempEau)'] . '</td><td>' . $donnees['round(AVG(TempEau))'] . '</td><td>' . $donnees['MAX(TempEau)'] . '</td><td>' . $donnees['round(STDDEV(TempEau))'] . '</td></tr>';
                }
                echo '</table>';
                ...
                {
                    echo 
                    '<tr><td>' . $donnees['year(`date`)'] . '</td><td>' . $donnees['min(NiveauEau)'] . '</td><td>' . $donnees['round(AVG(NiveauEau))'] . '</td><td>' . $donnees['MAX(NiveauEau)'] . '</td><td>' . $donnees['round(STDDEV(NiveauEau))'] . '</td></tr>';
                }
                echo '</table>';
